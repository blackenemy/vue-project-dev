...
<template>
    <div class="container mx-auto">
        <div class="navbar bg-base-100">
            <div class="flex-1">
                <RouterLink :to="{name: 'home'}" class="btn btn-ghost text-xl">Digimon List</RouterLink>
            </div>
            <div class="flex-none gap-2">
                ...
                <div tabindex="0" role="button" class="btn btn-ghost btn-circle avatar">
                    ...
                    <img alt="Tailwind CSS Navbar component" src="//upload.wikimedia.org/wikipedia/commons/9/99/Sample_User_Icon.png" />
                    </div>
                </div>
